...
public class WhitePlayerTaskA extends Thread {
    ...
    // constructor
    public WhitePlayerTaskA(String n, ReentrantLock r, Phaser phA) {
        name = n;
        lock = r;
        ph = phA;
        ph.register();
                    ...
                    for (int j = 0; j < BoardA.checkersGame[0].length; j++) {
                        ...
                        if (BoardA.checkersGame[i][j] == 1) {
                            ...
                            if (movesThisPiece == 1) {
                                ...
                                if (i == 0 || BoardA.checkersGame[i - 1][j] != 0)
                                    up = false;
                                if (i == 3 || BoardA.checkersGame[i + 1][j] != 0)
                                    down = false;
