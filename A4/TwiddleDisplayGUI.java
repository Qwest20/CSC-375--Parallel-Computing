...
public class TwiddleDisplayGUI extends JFrame {
    ...
    // Constructor
    public TwiddleDisplayGUI(int w, int h, int[][] tS, String wN, ArrayList<String> wM, int nM, int nT){
        this.width = w;
        this.height = h;
    ...
    public void paint(Graphics g) {
        ...
        g.setFont(new Font("Default", Font.BOLD, 25));
        g.drawString("Solving Moves (according to "+winningNode+"):", ((width*2)/5)-50,50);
